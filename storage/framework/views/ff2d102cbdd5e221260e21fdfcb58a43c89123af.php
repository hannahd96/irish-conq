            ...
            <div class="panel panel-default" id = "panel-background" style = "border:none;">
                <div class="panel-heading" id = "panel-background" style = "position:relative; background: rgba(204, 204, 204, 0.0); border:none;">
					...
					<div class = "col-sm-8">
						...
						<!--Username:
						<div id="edit" contenteditable="true" style = "border:1px solid black; padding:5px;"><?php echo e(Auth::user()->username); ?></div>
						<br>
						<input type="button" value="Save" onclick="saveEdits()" style="float:right; margin-right:30px; margin-bottom:10px;"/>
						<div id="update"></div>-->
						<hr>
						<form method="POST" action="<?php echo e(route('settings')); ?>" style = "color:black; margin:15px;">
							...
							<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
								...
								<div class = "form-group">
									...
									<input type="text" class = "form-control" id = "username" name = "username" value="<?php echo e(old('username', Auth::user()->name)); ?>" />
								</div>
								<div class = "form-group">
									
								</div>
								<!-- RETURNS USER TO INDEX -->
								<a href="<?php echo e(route('home')); ?>" class="btn btn-default" style = "margin-bottom:10px;">Cancel</a>
